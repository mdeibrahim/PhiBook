...
from .views import CreatePostView, UpdatePostView,DeletePostView, LikeUnlikeView,ViewMyPostsView,ViewAllPostsView,AddCommentView,UpdateCommentView,DeleteCommentView,ViewAllCommentsView,UserDataView
